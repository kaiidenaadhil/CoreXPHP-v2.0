...
<footer>
    <div class="footer-container">
        ...
        <div class="footer-column">
            <h3>Support</h3>
            <ul>
                <li>Email: <a href="mailto:support@codexbuilder.com">support@codexbuilder.com</a></li>
                <li>Phone: +880-152-1257123</li>
            </ul>
        </div>

        <div class="footer-column">
            <h3>About CodeXBuilder</h3>
            <p>
                Build robust, high-performance applications easily with our Core PHP MVC framework tool.
            </p>
        </div>
    </div>
    ...
    <div class="second-footer">
        <span>© 2024 CodeXBuilder. All rights reserved.</span>
    </div>
