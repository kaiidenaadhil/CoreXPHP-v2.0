  ...
  <div class="detail-layout">
    <div class="detail-data">
      ...
      <div class="detail-row">
        ...
        <div class="detail-value"><?= htmlspecialchars($lead->name ?? "-") ?></div>
      </div>
      <div class="detail-row">
      ...
      <div class="detail-row">
        <div class="detail-label">Service Interested</div>
        <div class="detail-value"><?= htmlspecialchars($lead->serviceInterested ?? "-") ?></div>
      </div>
      <div class="detail-row">
