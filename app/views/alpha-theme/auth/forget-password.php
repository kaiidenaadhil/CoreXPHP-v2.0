...
<body>
  <main>
  <form class="auth-form-container" method="POST" action="<?= ROOT ?>/forget-password">
      <a href="<?=ROOT?>" class="back-button"><i class="uil uil-arrow-left"></i> Back</a>
      <div class="logo">
        <?=APP_NAME?>
      </div>
      <h3>Forgot Password</h3>
      <p>You need to check your email to reset your password</p>
      ...
      <button type="submit" class="gradient-btn">Reset</button>
    </form>
  <!-- <form class="auth-form-container" method="POST" action="<?= ROOT ?>/register">
    ...
    <!-- <form class="auth-form-container" method="POST" action="<?= ROOT ?>/login">
      ...
      <h3>Log In</h3>
      <p style="text-align: center;">to continue to <b>uComfortBD</b></p>
      ...
      <div class="footer-text">
        <p>New to <b>uComfortBD</b>? <a href="<?= ROOT ?>/register">Create an Account</a></p>
      </div>
    </form> -->
  </main>
